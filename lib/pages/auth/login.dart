...
class _LoginScreenState extends State<LoginScreen> implements LoginScreenContract,AuthStateListener  {
                            ...
                            children: <Widget>[
                              ...
                              ButtonTheme(
                                ...
                                child: RaisedButton(
                                  ...
                                  elevation: 0.0,
                                  color: primaryColor,
                                  child: new Text('LOGIN AS USER',style: headingWhite,),
                                  onPressed: (){
                                    _submit();
                                  },
                                ),
                              ...
                              new GestureDetector(
                                ...
                                child:Container(
                                    ...
                                    child: new Row(
                                      mainAxisAlignment: MainAxisAlignment.center,
                                      children: <Widget>[
                                        new Text("Click here to login as agent",style: textStyleActive,),
                                      ],
                                    )
                                ),
                              ),
  ...
  void onLoginSuccess(chcUserModel user) async {
    Toast.show("Login Successful", context, duration: Toast.LENGTH_LONG, gravity:  Toast.TOP, backgroundColor:greenColor, textColor: Colors.white);
