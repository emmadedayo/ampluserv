...
class Menu extends StatefulWidget {
  ...
  final drawerItems = [
    ...
    new DrawerItem("Send Item", Icons.home),
...
class _MenuState extends State<Menu> implements AuthStateListener {
  ...
  Details() {
    if(_userModel != null){
      return UserAccountsDrawerHeader(
        accountEmail: Text(_userModel.email,style: textBoldWhites,),
        accountName: Text(_userModel.name,style: textBoldWhites,),
