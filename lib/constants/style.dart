...
TextStyle textBoldBlackw = const TextStyle(
  color: const Color(0XFF000000),
  fontSize: 17.0,
  fontWeight: FontWeight.bold,
  fontFamily: "OpenSans",
...
TextStyle textBoldWhites = const TextStyle(
  color: const Color(0XFFFFFFFF),
  fontSize: 16.0,
  fontWeight: FontWeight.bold,
  fontFamily: "OpenSans",
...
TextStyle newtextGreyBold = const TextStyle(
  color: Colors.black,
  fontSize: 17.0,
  fontWeight: FontWeight.normal,
  fontFamily: "OpenSans",
...
ThemeData appTheme = new ThemeData(
  ...
  accentColor: const Color(0xFF8ccb57),
...
Color textFieldColors = blackColor;
...
const Color activeColor = const Color(0xFF8ccb57);
const Color redColor = const Color(0xFFFF0000);
const Color buttonStop = const Color(0xFFF44336);
const Color primaryColor = const Color(0xFF274cbf);
const Color secondary = const Color(0xFF8ccb57);
...
TextStyle headingWhites = new TextStyle(
  color: Colors.white,
  fontSize: 18.0,
  fontWeight: FontWeight.bold,
  fontFamily: "OpenSans",
